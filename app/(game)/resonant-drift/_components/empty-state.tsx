    ...
    <div className="absolute inset-0 flex items-center justify-center z-15 bg-black/40">
      <Card className="w-full max-w-sm text-center p-4">
        <div className="flex items-center justify-center gap-3 mb-2">
          <div className="bg-gradient-to-tr from-indigo-600 to-purple-500 rounded-full h-9 w-9 flex items-center justify-center text-white shadow-sm">🌌</div>
          <div className="text-left">
            <h2 className="text-lg font-semibold">No Dormant Nodes Detected</h2>
            <p className="text-xs text-muted-foreground">Try exploring beyond 10km to find drift targets</p>
          </div>
        </div>
        ...
        <ul className="text-sm text-muted-foreground space-y-2 my-3 text-left">
          ...
          <li>• Pioneer must not be on cooldown — wait 72 hours after a drift</li>
        </ul>
