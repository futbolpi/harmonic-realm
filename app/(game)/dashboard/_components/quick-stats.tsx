...
const QuickStats = ({ minerShares, nodesMined, piEarned }: QuickStatsProps) => {
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      ...
      <Card className="game-card">
        <CardContent className="p-4 text-center">
          ...
          <p className="text-xs text-muted-foreground">Pi Earned</p>
        </CardContent>
      </Card>
      ...
      <Card className="game-card">
        <CardContent className="p-4 text-center">
          ...
          <p className="text-xs text-muted-foreground">Nodes Mined</p>
        </CardContent>
      </Card>
